...
function sleep_job(url, auth, auth_cb, timeout, async_job_check_time_ms, service_version) {
    var self = this;
    ...
    var _auth_cb = auth_cb;
     ...
     this.simple_sleep = function (params, _callback, _errorCallback) {
        ...
        return json_call_ajax(_url, "sleep_job.simple_sleep",
    ...
    this.status = function (_callback, _errorCallback) {
        ...
        return json_call_ajax(_url, "sleep_job.status",
